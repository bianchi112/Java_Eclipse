...
public class Ex05 {
	public static void main(String[] args) {
		...
		// 위치값(=index=0부터시작) 숫자가 들어오면 해당 위치에 있는 문자(char)를 반환한다.
		char c1 = str.charAt(3);
		System.out.println(c1);
		System.out.println("=====================");

		// 소문자를 대문자롤 변경 ( 대문자 == 소문자 - 32 )
		...
		// 지금은 String 이라고 생각하자
		// 입력된 문자열이 현재 문장열에 포함되어 있으면 true, 없으면 false ;
		...
		String s35 = "남궁선우";
		int kkk = s35.length() - 2;
		s34 = "*";
		System.out.println(s35.replace(s35.substring(1, 2), s34));
		// 숙제) 이름이 4개이상일때 * 표시하기 (for문이용)
		System.out.println("-------------------------");
		// 15. toLowerCase() : String
		// 해당 문자열의 대문자을 소문자로 변경
		// toUpperCase() : String
		// 해당 문장열의 소문자를 대문자로 변경
		s35 = "한국 ICT 인재 개발원 1004 Love You !!!";
		String s36 = s35.toLowerCase(); // 대문자 -> 소문자
		String s37 = s35.toUpperCase(); // 소문자 -> 대문자
